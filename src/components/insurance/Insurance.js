...
const arrayCard = [
    {
        ...
        title: "САЛАТ ИЗ МИКС ЗЕЛЕНИ",
        description: "Сочетание свежих видов салатов, политых нежной бальзамической заправкой и ароматным оливковым маслом)",
        price: "169 сом"
    },
    {
        id: 2,
        ...
        description: "Свежие помидоры, хрустящие огурцы и сочный болгарский перец в сочетании с лимонной заправкой и ароматным оливковым маслом",
        price: "169 сом"
    },
    {
        id: 34,
        ...
        title: "ЮНИОР ШАВЕРМА",
        description: "Куриное мясо, с ароматным соусом, свежие помидоры, хрустящий картофель рататуй, а завершающий аккорд – чесночный соус, придающий блюду неповторимый шарм упаковка",
        price: "189 сом"
    },
    {
        id: 3,
        ...
        title: "СТАНДАРТНАЯ ШАВЕРМА",
        description: "Сочное мясо, пропитанное уникальным соусом от нашего шеф-повара, обрамленное свежими помидорами и луком, хрустящий картофель рататуй и в завершении чесночный соус",
        price: "229 сом"
    },
    {
        id: 4,
        ...
        title: "АРАБСКАЯ ШАВЕРМА",
        description: "Насыщенное мясо, пропитанное ароматным соусом от шеф-повара, обволакивается свежими помидорами, картофелем рататуй, а затем традиционным хумусом и соусом тахини",
        price: "289 сом"
    },
    {
        id: 5,
    ...
    },
    {
        ...
        title: "АЗИАТСКАЯ ШАВЕРМА",
        description: "Мягкое мясо, в сочетании с ароматными помидорами, картошкой рататуй и всё это завершается сладким соусом чили, соусом от шеф-повара и перцем халапеньо",
        price: "289 сом"
    },
    {
        id: 7,
        ...
        title: "ЧЕДДАР ШАВЕРМА",
        description: "Мясо, сочные помидоры, картошка рататуй, обильный сыр чеддер и завершающий аккорд – соус барбекю",
        price: "319 сом"
    },
    {
        id: 8,
        ...
        title: "СЫРНАЯ ШАУРМА",
        description: "Сочное мясо, ароматные помидоры, картофельный рататуй, чесночный соус, завершенные нежным сыром моцарелла",
        price: "309 сом"
    },
    {
        id: 9,
        ...
        title: "БОКС ШАВЕРМА",
        description: "Ароматное куриное мясо, свежие помидоры, хрустящий лук, салат из краснокочанной капусты, картошка рататуй и завершающая нота – картофельные чипсы",
        price: "339 сом"
    },
    {
        id: 10,
        ...
        title: "ШАВЕРМА ТОМБИК",
        description: "Свежий хлеб, куриное мясо, свежие помидоры и неповторимый коктейльный соус",
        price: "359 сом"
    },
    {
        id: 11,
        ...
        title: "ИНЕГОЛЬ КЕБАБ БОКС",
        description: "Инеголь кебаб, сочные помидоры, свежий лук, красочный салат из краснокочанной капусты, хрустящие картофельные чипсы и соус тахини",
        price: "399 сом"
    },
    {
        id: 12,
        ...
        title: "ТОМБИК ИНЕГОЛЬ КЕБАБ",
        description: "Слияние восточных вкусов в каждом слое: инеголь кебаб, свежие помидоры, лук, салат из краснокочанной капусты и хрустящий картофель",
        price: "419 сом"
    },
    {
        id: 13,
        ...
        title: "ИНЕГОЛЬ КЕБАБ ДУРУМ",
        description: "Инеголь кебаб, освежающие помидоры, лук, ароматный картофель и обволакивающий соус барбекю",
        price: "349 сом"
    },
    {
        id: 14,
        ...
        title: "ШЕФ КОМБО",
        description: "Куриный томбик, хрустящий картофель фри в сочетании с кетчупом и майонезом, а также баночка Coca Cola 300мл.",
        price: "499 сом"
    },
    {
        id: 15,
        ...
        title: "БИГ БОСС",
        description: "Томбик Инеголь Кебаб, хрустящий картофель фри, дополненные кетчупом и майонезом, а завершающая нота - прохладная Coca Cola 300 мл",
        price: "539 сом"
    },
    {
        id: 16,
    ...
    },
    {
        ...
        title: "Де люкс шаверма",
        description: "Нежное мясо и авторский соус от шеф-повара, свежие помидоры и огурцы, хрустящий картофель рататуй и завершающий штрих с тремя видами соуса: сладко острый соус, коктейльный и шеф соус",
        price: "319 сом"
    },
    {
        id: 18,
        ...
        title: "Мексико шаверма",
        description: "Нежное мясо и авторский соус от шеф-повара, свежие помидоры и огурцы, хрустящий картофель рататуй и завершающий штрих - с шеф соусом",
        price: "289 сом"
    },
    {
        id: 19,
        ...
        title: "Американо шаверма",
        description: "Курица обжаренная до золотистой корочки,фирменный соус, сочный помидор, хрустящий солёный  огурец, жаренная картошка рататуй и авторский соус Бармастард",
        price: "289 сом"
    },
    {
        id: 20,
        url: "https://i.wfolio.com/x/KfN2JhbB89-m6UeUSQ-43b-4LTDPyZVn/q6sVLUvjujnOk6mXbO2srbIKpPlcOqy0/t7rVx8PT5NFW95R5iPfYgBdCvXqdZSYC/zyAGIGx14QnH8prwkbZ-T_VQC0dpw9Hp/imD7pN62XUepN3NSIwunZtHvq02v6LB8/yE5Gq-OAOOI1IX2tTmQsOLmgNkTbQVHl/hATQDrKIpTjQz5Le9VKwpiiYp9LlVfKN/S39tj667aW8d2iZLjo7c7b8v02WT2V4m/b3gUlBeXO6ScLEOwzOuXv1G8Lj39YqLn/odMLIaXGn8nhBhGnubZrJUfE5b3vvKvA/PW2spDOzsXeWfiDl0vr08Q5sBajkBP3v/jYX-1lHtddPi3q7XiXAFzczwmo4PZ2RC/7FJKauejoaEinkSxqNCNMRmuBOFBdeAm/tbm3Kbl3gJtZUbQpORk1cRwS8dRMhW-K/EGxHMn7u1rbCXnoC_fRSEA3wiGV-zofM/bnNXwtYFgJfvbFTTwADdHeQtv-UP8YD6/L32jWXynsL_ReF3s-t7fdKDRL_IKZVOm/anC3pyRC__E.jpg",
        title: "Токио шаверма",
        description: "Курица обжаренная до золотистой корочки, фирменный соус, помидор, солёные огурцы, картофель рататуй,соус Терияки)",
        price: "289 сом"
    },
]
function Insurance(){
